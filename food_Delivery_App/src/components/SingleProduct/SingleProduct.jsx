...
const SingleProduct = () => {
    ...
    const [img,setImg] = useState("https://www.jiomart.com/images/product/600x600/490005239/kissan-pineapple-jam-500-g-product-images-o490005239-p490005239-1-202203151442.jpg");
    ...
    <div className='sideImages'>
        {
         data?.photos?.map( (img) => {
            return (
                <img key={img} src={img} onClick={()=>setImg(img)}/>
            )
         })
        }
...
<div className='rightBox'>
    ...
    <div className='counter'>
        <button onClick={()=>Increment()} className='incBtn btn'>+</button>
